---
"@animakit/homeostasis": minor
---

Initial release of `@animakit/homeostasis` — a stress/dopamine homeostatic state machine for LLM agents, extracted from Anima's production agent (53 sprints).
