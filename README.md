...
| [`@animakit/git-guardrails`](packages/git-guardrails) | Human-in-the-loop confirmation for agents with git/shell access | ✅ [npm](https://www.npmjs.com/package/@animakit/git-guardrails) |
...
MIT © Justine Serna, except `@animakit/git-guardrails` which is Apache-2.0 (see its own `LICENSE`).
